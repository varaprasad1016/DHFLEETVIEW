import{w as C,x as w,e as b,y as k,k as S,C as x,E as R,F as M,G as $,ap as h,aq as m,ar as c}from"./index-D7cmEozw.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return C("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const E=t=>{const{classes:e,variant:a,animation:o,hasChildren:s,width:n,height:i}=t;return R({root:["root",a,o,s&&"withChildren",s&&!n&&"fitContent",s&&!i&&"heightAuto"]},X,e)},r=h`
  0% {
    opacity: 1;
  }
