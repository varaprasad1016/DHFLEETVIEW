...
Player.prototype.initDownloadWorker = function () {
    var self = this;
    this.downloadWorker = new Worker(js_path + "downloader.js");
...
Player.prototype.initDecodeWorker = function () {
    var self = this;
    this.decodeWorker = new Worker(js_path + "decoder.js");
...
Player.prototype.gpsAudioClose = function(){
    if (this.playerState != playerStatePlaying) {
        var ret = {
            e: -1,
            m: "Not playing"
...
Player.prototype.gpsAudioOpen = function(){
    if (this.playerState != playerStatePlaying) {
        var ret = {
            e: -1,
            m: "Not playing"
