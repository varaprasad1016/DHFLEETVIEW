...
import TachoBridgePanel from './components/TachoBridgePanel';
      ...
      <Box sx={{ p: 2 }}>
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          <Grid item xs={6} sm={3}>
            <Card>
              <CardContent>
                <Typography variant="caption">Vehicles</Typography>
            ...
            {[
              {
                ...
                desc: 'All tools & licence status',
                href: '/tacho/compliance',
                icon: <DashboardCustomizeIcon />,
              },
              {
                label: 'Walkaround reports',
                desc: "All drivers' checks, photos & signatures",
                href: '/tacho/walkaround-reports',
                icon: <FactCheckIcon />,
                module: 'walkaround_reports',
              },
              {
                label: 'Vehicle defects',
                desc: 'Defects & rectification log',
                href: '/tacho/defects',
                icon: <WarningAmberIcon />,
                module: 'defects',
              },
              {
                label: 'Tacho compliance',
                desc: "Drivers' hours & WTD, archive",
                href: '/tacho/hours',
                icon: <AccessTimeIcon />,
                module: 'tacho',
              },
              {
                label: 'MOT & tax reminders',
                desc: 'DVLA MOT, tax & Euro status',
                href: '/tacho/reminders',
                icon: <EventAvailableIcon />,
                module: 'reminders',
              },
              {
                label: 'Clean Air Zone',
                desc: 'ULEZ / CAZ charge exposure',
                href: '/tacho/caz',
                icon: <AirIcon />,
                module: 'caz',
              },
              {
                label: 'Driver app',
                desc: 'Shifts, walkarounds, jobs, fuel & faults',
                href: '/tacho/driver',
                icon: <LocalShippingIcon />,
                module: 'driver_app',
              },
              {
                label: 'Drivers & app PINs',
                desc: 'Add drivers and set their app PIN',
              ...
              },
              {
                ...
                desc: 'Send jobs & message drivers',
                href: '/tacho/jobs',
                icon: <AssignmentIcon />,
                module: 'jobs',
              },
              {
                label: 'Shift reports',
                desc: 'Active shifts, history & photos',
                href: '/tacho/shifts',
                icon: <ScheduleIcon />,
                module: 'shifts',
              },
              ...
              .filter(
                (tool) => !tool.module || !enabledModules || enabledModules[tool.module] !== false,
              )
              .map((tool) => (
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', gap: 2, mt: 2, flexWrap: 'wrap' }}>
                <TextField
                  ...
                  onChange={(e) =>
                    setConfig({ ...config, driverDownloadIntervalDays: Number(e.target.value) })
                  }
                />
                <TextField
                  ...
                  onChange={(e) =>
                    setConfig({ ...config, vehicleDownloadIntervalDays: Number(e.target.value) })
                  }
                />
              </Box>
        ...
        <Paper sx={{ p: 2, mb: 3 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
            ...
            <Button size="small" onClick={loadDownloads}>
              Refresh
            </Button>
          </Box>
          <TableContainer>
                    ...
                    <TableCell>
                      {[
                        ...
                        <Button
                          size="small"
                          onClick={async () => {
                            await tachoCancelDownload(job.id);
                            loadDownloads();
                          }}
                        >
                          Cancel
                ...
                {files.map((f) => (
                  <TableRow key={f.id}>
                    ...
                    <TableCell>
                      <Button
                        size="small"
                        href={`/api/tachograph/files/${f.id}/download`}
                        target="_blank"
                        rel="noopener"
                      >
                        Download DDD
        ...
        <Box sx={{ mt: 2 }}>
          <Typography variant="caption" color="text.secondary">
            Simulator mode:{' '}
            {String(
              JSON.stringify({ note: 'Enable tacho.simulator=true for testing without hardware' }),
            )}
          </Typography>
        </Box>
      </Box>
